package id.ac.poliban.mi.Aulia.phonenumbrespressospinner_061;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("PhoneNumber SpinnerEspresso_035 AULIA-E020320035");
